...
request({url: 'https://data.oologic14.hasura-app.io/v1/template/tbl_user_favorite_list?tbl_user_profileunique_id='+user_unique_id,
	method: 'GET',
	headers: {'Content-Type':'application/json','Authorization':'Bearer e2wb0wgxm1k16uuxvdlfz0zk87l7rx6s'}
